...
class ReceiveTaskAdapter extends RecyclerView.Adapter<ReceiveTaskAdapter.MyViewHolder> {
    ...
    public ReceiveTaskAdapter(Context context, List<TaskItem> list) {
...
//                String message=position+"";
                Intent intent = new Intent(context, Activity_MyReceive.class);
