...
class IngAdapter extends RecyclerView.Adapter<IngAdapter.MyViewHolder> {
    ...
    public IngAdapter(Context context, List<TaskItem> list) {
...
//                String message=position+"";
                Intent intent = new Intent(context, Activity_Mying.class);
