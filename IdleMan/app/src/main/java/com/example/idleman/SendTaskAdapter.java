...
class SendTaskAdapter extends RecyclerView.Adapter<SendTaskAdapter.MyViewHolder> {
    ...
    public SendTaskAdapter(Context context, List<TaskItem> list) {
...
//                String message=position+"";
                Intent intent = new Intent(context, Activity_MySend.class);
